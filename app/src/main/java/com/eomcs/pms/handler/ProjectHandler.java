...
public class ProjectHandler {
  ...
  public ProjectHandler(List<Project> projectList, MemberHandler memberHandler) {
    ...
    project.setStartDate(Date.valueOf("20121-1-1"));
    ...
    project.setContent("내용!");
    project.setStartDate(Date.valueOf("2021-1-2"));
    project.setEndDate(Date.valueOf("2021-2-3"));
  ...
  public void update() {
    ...
    List<Member> members = memberHandler.promptMembers(String.format(
        "팀원(%s)?(완료: 빈 문자열) ", getMemberNamesproject.getMembers()))));
